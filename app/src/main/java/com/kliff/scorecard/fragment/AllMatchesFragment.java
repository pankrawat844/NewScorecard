    ...
    void executeURL(int Command, String URL) {
        ...
        switch (Command) {
            case 1:
                ...
                executeReturn = new AllMatchesFragment.DisplayMatcheListAndMiniScoreCBZ().execute(new String[]{URL});
                break;
            case 2:
                IsMatcheListESPNRan = false;
                IsMiniScoreESPNRan = false;
                executeReturn = new AllMatchesFragment.DisplayMatcheListESPN().execute(new String[]{URL});
                break;
            case 3:
                IsMatcheListESPNRan = false;
                IsMiniScoreESPNRan = false;
                executeReturn = new AllMatchesFragment.DisplayMiniScoreESPN().execute(new String[]{URL});
                break;
        }
...
//            MainActivity.this.overridePendingTransition(R.anim.anim_slide_in_left, R.anim.anim_slide_out_left);
    ...
    public class DisplayMatcheListAndMiniScoreCBZ extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            AllMatchesFragment.this.fillMatchListAndMiniScoreCBZ(result);
            IsMatcheListAndMiniScoreCBZRan = true;
            if (IsMatcheListESPNRan || IsMiniScoreESPNRan) {
                Utils.clearAnimation(AllMatchesFragment.this.btnRefresh);
            }
        }
    }
